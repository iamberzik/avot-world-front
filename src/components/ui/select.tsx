...
>(({ className, children, ...props }, ref) => (
	<SelectPrimitive.Trigger
		...
		className={cn(
			...
			' ring-offset-white placeholder:text-slate-500 font-[500] focus:outline-none ' +
			'focus:ring-2 focus:ring-secondary disabled:cursor-not-allowed disabled:opacity-50 ' +
			'[&>span]:line-clamp-1',
			className
		)}
		{...props}
